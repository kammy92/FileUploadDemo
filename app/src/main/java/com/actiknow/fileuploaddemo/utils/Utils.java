package com.actiknow.fileuploaddemo.utils;
...
import com.actiknow.fileuploaddemo.R;
import com.actiknow.fileuploaddemo.app.AppController;
...
public class Utils {
    ...
    public static void showSnackBar (Activity activity, View view, String message, int duration, String button_text, View.OnClickListener onClickListener) {
        ...
        textView2.setTextColor (activity.getResources ().getColor (R.color.text_white));
